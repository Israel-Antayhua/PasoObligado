...
-->
            ...
            <main>
                ...
                <div class="video-div">
                    <h1 class="titulo_1">¡Porque tú lo pediste, sobrino…próximamente¡</h1>
                    <video class="video" muted autoplay loop>
                        <source
                            src="MULTIMEDIA/INDEX/video.mp4">
                    </video>
                </div>

                <!--1era caja-->

                <h1 class="titulo_1">El secreto está en la leña... y en el corazón.!!</h1>

                <div class="row justify-content-center">
                    <c:forEach items="${productos}" var="item" varStatus="status">
                            <div class="col-md-4">
